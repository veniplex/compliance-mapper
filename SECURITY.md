...
- The application reads only from static JSON data files; no database or user-supplied data is persisted.
- Sensitive configuration (e.g., `PORT`) is managed via environment variables — never commit a populated `.env` file.
